...
const AboutPage = () => {
  return (
    <Container mt={120} mb={30} maxWidth="container.md">
      <Text mb={5}>
        ...
        <Text mb={5}>
          ...
          bills including one on Alternate Dispute Resolution.
        </Text>
        <Text mb={5}>
          He also chaired the sub-committee of EVM’s, Digital Identification of
